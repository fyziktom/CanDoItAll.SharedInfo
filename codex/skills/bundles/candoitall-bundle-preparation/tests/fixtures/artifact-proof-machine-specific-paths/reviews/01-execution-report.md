...
|---|---|---|---|---|---|
| 01 | Passed | Passed | Passed | Passed | Semantic proof, `proof/SB01/manifest.md`, and `proof/SB01/semantic-invariants.md` included. |
...
|---|---|---|
| Require semantic proof | Solved | SB01 semantic proof block, `proof/SB01/manifest.md`, and `proof/SB01/semantic-invariants.md` |
