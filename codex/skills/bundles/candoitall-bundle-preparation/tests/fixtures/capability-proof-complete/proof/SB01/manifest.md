...
- Source assertion: `bundle://source/multilingual-professor-extraction.cs`
- Source assertion: `bundle://source/embedding-cluster-provider.cs`
...
|---|---|---|---|---|
| `Czech/diacritic` | `bundle://source/multilingual-professor-extraction.cs` | `bundle://proof/SB01/transcripts/passing.txt` runs `ArtifactProof.ValidatesCompleteFixture` | `bundle://proof/SB01/transcripts/failing-first.txt` rejects the English-only negative fixture | Verified pass |
| `embedding-backed` | `bundle://source/embedding-cluster-provider.cs` | `bundle://proof/SB01/transcripts/passing.txt` runs `ArtifactProof.ValidatesCompleteFixture` | `bundle://proof/SB01/transcripts/failing-first.txt` rejects the lexical-only negative fixture | Verified pass |
