...
## Invariant PROOF-PORTABILITY-NOT-CITED

- Invariant ID: `PROOF-PORTABILITY-NOT-CITED`
...
- Failing-first test: `ArtifactProof.ValidatesCompleteFixture` in `bundle://proof/SB01/transcripts/failing-first.txt`.
- Passing test: `ArtifactProof.ValidatesCompleteFixture` in `bundle://proof/SB01/transcripts/passing.txt`.
