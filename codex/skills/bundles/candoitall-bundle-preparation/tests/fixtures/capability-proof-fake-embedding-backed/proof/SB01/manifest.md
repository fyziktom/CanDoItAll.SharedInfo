...
- Source assertion: `bundle://source/lexical-only-cluster-provider.cs`
...
|---|---|---|---|---|
| `embedding-backed` | `bundle://source/lexical-only-cluster-provider.cs` | `bundle://proof/SB01/transcripts/passing.txt` runs `ArtifactProof.ValidatesCompleteFixture` | `bundle://proof/SB01/transcripts/failing-first.txt` rejects a lexical-only negative fixture | Verified pass |
